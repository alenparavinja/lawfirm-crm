...
const staffData = [
  { fullName: 'Maria Rodriguez', role: 'attorney',  email: 'mrodriguez@lawfirm.com', barNumber: 'NY-2018-44521', active: true,  biography: 'Maria leads the family-based immigration practice, handling petitions, adjustment of status, and consular processing. She has represented clients before USCIS field offices across the Northeast since 2018.', passwordHash: '$2b$10$5CwiSyW/LgOg8u2ZgRBOnuLWJc20u.dsQVsl8h4e4v6YHmkmqfeLu' },
  { fullName: 'James Chen',      role: 'attorney',  email: 'jchen@lawfirm.com',       barNumber: 'NY-2015-33102', active: true,  biography: 'James focuses on employment-based visas and handles the firm\'s larger corporate sponsorship matters. He joined in 2015 after several years in business immigration at a mid-size firm.', passwordHash: '$2b$10$GejVHaZyax/ciEo.h9R.COvmkjqkMbbt9yH2Y3LOxN9nx8D0aHQI.' },
  { fullName: 'Sarah Kim',       role: 'attorney',  email: 'skim@lawfirm.com',        barNumber: 'NY-2020-55789', active: true,  biography: 'Sarah handles asylum and removal defense, with particular experience in cases involving clients from East Asia. She joined in 2020 and works closely with the litigation team on appeals.', passwordHash: '$2b$10$J0GsXiH3MWFWuBNv/6RWxeZRL901Hpuk.Hl1gSz6ediqPoSN08dTu' },
  { fullName: 'David Okafor',    role: 'paralegal', email: 'dokafor@lawfirm.com',     barNumber: null,            active: true,  biography: 'David supports the family and naturalization caseloads, preparing filings and tracking priority dates and receipt notices. He is the main point of contact for clients navigating document collection.', passwordHash: '$2b$10$GxKLfXrs51ugzzKITwLutOM65gA.CtF4B30Z.Klb/sj4670ROah4i' },
  { fullName: 'Ana Gutierrez',   role: 'paralegal', email: 'agutierrez@lawfirm.com',  barNumber: null,            active: true,  biography: 'Ana manages document intake and case file organization across active matters. She is fluent in Spanish and handles much of the client communication in family petition cases.', passwordHash: '$2b$10$neBggUwj3ugB1CLMakQlcePcaP8QK8YoKS8wQXHDIZGXYukIXiPZ.' },
  { fullName: 'Michael Torres',  role: 'admin',     email: 'mtorres@lawfirm.com',     barNumber: null,            active: true,  biography: 'Michael oversees scheduling, billing, and office operations. He keeps case calendars and filing deadlines coordinated across the legal staff.', passwordHash: '$2b$10$7RN92S4qDA1LP.mqZx8wl.OxfxDqVWswz0d7Lmmpx4DJFuZ8e6v7O' },
  { fullName: 'Linda Park',      role: 'attorney',  email: 'lpark@lawfirm.com',       barNumber: 'NY-2012-22098', active: false, biography: 'Linda practiced employment and investor visa work for over a decade before stepping back from active casework. She remains available to the team in an advisory capacity.', passwordHash: '$2b$10$iUZdNky54vhNCQ6cHVugquhupLpgaImmy7kHb7qknneX.2bvIX.X6' },
];
